...
- **`docs/openclaw-setup.md`**、**`docs/zh/openclaw-setup.md`**、**`docs/getting-started.md`**、**`docs/zh/getting-started.md`**、**`README.md`** 与 **`README_EN.md`** — 补充 OpenClaw 频道配置与 QMD 独立安装的入口说明。
